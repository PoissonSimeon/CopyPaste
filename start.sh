...
echo "========================================="
echo "  Démarrage du Serveur CopyPaste"
echo "========================================="
...
if [ ! -d "node_modules" ]; then
    echo "[Info] Dossier node_modules introuvable. Installation des dépendances..."
...
while true; do
    # L'option --max-old-space-size=256 est vitale pour ton Proxmox de 512 Mo
